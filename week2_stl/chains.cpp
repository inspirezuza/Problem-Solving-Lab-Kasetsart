...
// struct เก็บชี้ 2 ตัว ไม่ต้องสนใจ next, prev
// การเดิน จะเก็บค่า iter กับ backward ไว้ ต่างจากโค้ดผมที่ต้องเก็บทั้ง iter, forward, backward
// ถ้าเดินไปด้านหน้า iter จะเดินไปทางตรงกันข้าม backward
// ถ้าเดินไปด้านหลัง backward จะเดินไปทางตรงกันข้าม iter
